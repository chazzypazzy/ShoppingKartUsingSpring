...
<title>Seller Verify OTP Page</title>
			...
			<div class="col-md-4 offset-md-4">
				<div class="car paint-card">
					<div class="card-body">
						...
						<${failOTP }<br>
						<form
							action="${pageContext.request.contextPath}/seller_verify_OTP">
							<input type="text" name="otp" placeholder="Enter Your OTP"><br>
							<br> <input type="submit" value="Verify" class="btn btn-danger"><br> <br>
						</form>
					</div>
				</div>
			</div>
